package week10.cindyaristawati.umn.ac.id.Services;
...
import week10.cindyaristawati.umn.ac.id.MainActivity;
import week10.cindyaristawati.umn.ac.id.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStartService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ServicesActivity.this, CustomService.class);
                startService(intent);
            }
        });
